...
import { AuditLogViewer } from '../../core/components/AuditLogViewer';
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="purchase.metadata_corrected">Correcao de metadados (compra)</option>
                                <option value="stock.movement_created">Movimento de stock criado</option>
                                <option value="stock.movement_updated">Movimento de stock atualizado</option>
                                <option value="stock.adjustment_created">Ajuste de stock criado</option>
                                <option value="stock.audit_applied">Auditoria de stock aplicada</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="stock_movement">Movimento de stock</option>
                                <option value="stock_adjustment">Ajuste de stock</option>
                                <option value="stock_audit">Auditoria de stock</option>
                            </select>
                        </div>
                    </div>
